...
parser.add_argument('--bot', '-b',
                    help='Opponent is a second instance of SmashBro',
                    default=False)
parser.add_argument('--debug', '-d', action='store_true',
                    help='Debug mode. Creates a CSV of all game state')
#default=5 to turn off attacking and defending
parser.add_argument('--difficulty', '-i', type=int, default=4,
                    help='Manually specify difficulty level of SmashBro')
parser.add_argument('--dolphinexecutable', '-e', type=is_dir,
                    help='Manually specify Dolphin executable')
#stage pick
parser.add_argument('--stage', '-s', default="YS",
...
while True:
    ...
    # TODO print
    # print('menu', gamestate.menu_state, gamestate.frame)
    ...
    # if gamestate.menu_state == melee.enums.Menu.STAGE_SELECT:  # problem: can't interact during loading screen
    #     if gamestate.frame == 0:  # for random select
    #         controller_one.press_button(Button.BUTTON_A)
    #     if controller_one.prev.button[Button.BUTTON_A]:
    #         controller_one.press_button(Button.BUTTON_A)
